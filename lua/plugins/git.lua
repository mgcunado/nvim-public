...
return {
  -- Git
  {
    ...
    config = function()
      ...
      -- git diff with previous commits
      map("n", "<leader>gdh1", ":Gdiffsplit HEAD~1<cr>")
      map("n", "<leader>gdh", ":Gdiffsplit HEAD~")

      -- git commits splits
      map("n", "<leader>gsh1", ":Gsplit HEAD~1:%<cr>")
      map("n", "<leader>gsh", ":Gsplit HEAD~ :%")
      map("n", "<leader>gvh1", ":Gvsplit HEAD~1:%<cr>")
      map("n", "<leader>gvh", ":Gvsplit HEAD~ :%")
